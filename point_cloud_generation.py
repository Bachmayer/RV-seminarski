...
def depth_to_point_cloud(image):
    ...
    far = 1000.0  # max depth u metrima, kako bi se izbjegle tacke koje su predaleko
...
def run_carla_client(host, port):
	...
	#print(Hcc)  #rotira je po roll za -90 i yaw za 90, prije slanja u transform funkciju
        ...
        #moze se preskociti prvih 20-ak frameova dok se ono auto ne ustabili nakon spawn-anja
        for frame in range(1, number_of_frames):
            ...
            # RGB image [[[r,g,b],..[r,g,b]],..[[r,g,b],..[r,g,b]]]ti
	    ...
	    #inace ga nema potrebe racunati ovdje, nego cemo u vsc, ali ovo je bilo zbog testa
            ...
            #ovim imamo point cloud u KS kamere...eventualno ga mozemo prebaciti u KS auta, 
	    #ali su to koord. sistemi koji se krecu skupa
            #Elem, moglo bi se primjeniti ovako

            #point_cloud.apply_transform(Hcc)


            # Spasava ply file 3D tacaka (i mogu boje, ako dodas i RGB) koji se moze vizualizirati npr. u meshlabu
	    # a mi cemo ga citati u glavnom programu
	    ...
	    print('(x,y)')
	    print(player_measurements.transform.location.x, player_measurements.transform.location.y)
